...
class _Scene5State extends State<Scene5> with WidgetsBindingObserver {
  final GifController _gifControllerScene5_1 = GifController();
  final GifController _gifControllerScene5_2 = GifController();
  static const MethodChannel _channel = MethodChannel('Scene_5');
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        startAudioFromBeginning(
                            'hmong_ntsuab_audio/scene_5.m4a');
                        playBackgroundAudio('background_audio/scene_5.mp3');
