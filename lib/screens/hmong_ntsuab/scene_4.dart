...
class _Scene4State extends State<Scene4> with WidgetsBindingObserver {
  final GifController _gifControllerScene4_1 = GifController();
  final GifController _gifControllerScene4_2 = GifController();
  static const MethodChannel _channel = MethodChannel('Scene_4');
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              ...
              child: SizedBox(
                child: GifView.asset(
                  'assets/hmong_dwab_gif/scene-4.1.gif', // Replace with your .gif file path
                  height: 35.h,
          ...
          Positioned(
              ...
              child: SizedBox(
                child: GifView.asset(
                  'assets/hmong_dwab_gif/scene-4.2.gif', // Replace with your .gif file path
                  height: 35.h,
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        startAudioFromBeginning(
                            'hmong_ntsuab_audio/scene_4.m4a');
                        playBackgroundAudio('background_audio/scene_4.mp3');
