...
class SceneD3 extends StatefulWidget {
  const SceneD3({Key? key}) : super(key: key);
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              ...
              child: SizedBox(
                child: GifView.asset(
                  'assets/hmong_dwab_gif/scene-3.1.gif', // Replace with your .gif file path
                  height: 30.h,
          ...
          Positioned(
              ...
              child: SizedBox(
                child: GifView.asset(
                  'assets/hmong_dwab_gif/scene-3.2.gif', // Replace with your .gif file path
                  height: 30.h,
                ...
                : Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        startAudioFromBeginning('hmong_dwab_audio/scene_3.m4a');
                        playBackgroundAudio('background_audio/scene_3.mp3');
