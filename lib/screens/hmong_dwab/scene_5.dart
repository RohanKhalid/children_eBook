...
import 'package:ebook/screens/hmong_dwab/scene_4.dart';
import 'package:ebook/screens/hmong_dwab/scene_6.dart';
...
class SceneD5 extends StatefulWidget {
  const SceneD5({Key? key}) : super(key: key);

  @override
  _SceneD5State createState() => _SceneD5State();
}

class _SceneD5State extends State<SceneD5> with WidgetsBindingObserver {
  final GifController _gifControllerScene5_1 = GifController();
  final GifController _gifControllerScene5_2 = GifController();
  static const MethodChannel _channel = MethodChannel('Scene_D5');
                ...
                : Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        startAudioFromBeginning('hmong_dwab_audio/scene_5.m4a');
                        playBackgroundAudio(
                          'background_audio/scene_5.mp3',
                        );
